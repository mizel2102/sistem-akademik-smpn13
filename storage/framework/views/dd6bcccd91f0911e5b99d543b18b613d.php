...
<?php $__env->startSection('breadcrumb', 'Siswa › Riwayat Absensi'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div class="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p class="mt-4 text-3xl font-bold text-navy"><?php echo e($totalAttendance); ?></p>
        </div>

        <div class="rounded-2xl bg-white p-6 shadow-sm">
            <p class="text-sm font-semibold uppercase tracking-wide text-slate-500">Hadir</p>
            <p class="mt-4 text-3xl font-bold text-navy"><?php echo e($presentCount); ?></p>
        </div>

        <div class="rounded-2xl bg-white p-6 shadow-sm">
            <p class="text-sm font-semibold uppercase tracking-wide text-slate-500">Tidak Hadir</p>
            <p class="mt-4 text-3xl font-bold text-navy"><?php echo e($absentCount); ?></p>
        </div>
    </div>

    <div class="rounded-2xl bg-white p-6 shadow-sm">
        <form method="GET" action="<?php echo e(request()->url()); ?>" class="grid gap-4 lg:grid-cols-4 lg:items-end">
            ...
            <div class="flex flex-col gap-3 sm:flex-row lg:flex-col">
                ...
                <a href="<?php echo e(request()->url()); ?>" class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="overflow-hidden rounded-2xl bg-white shadow-sm">
        <div class="overflow-x-auto">
            <table class="w-full border-collapse">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $statusMap = [
                        ...
                        <tr class="border-t border-slate-200 <?php echo e($loop->even ? 'bg-slate-50' : ''); ?> hover:bg-slate-100">
                            <td class="px-6 py-4 text-sm font-medium text-slate-900"><?php echo e($attendances->firstItem() + $i); ?></td>
                            <td class="px-6 py-4 text-sm text-slate-900"><?php echo e($attendance->academicClass?->name ?? '-'); ?></td>
                            <td class="px-6 py-4 text-sm text-slate-900"><?php echo e($attendance->attendance_time?->format('d M Y H:i') ?? '-'); ?></td>
                            ...
                            <td class="px-6 py-4 text-sm text-slate-900"><?php echo e($attendance->ip_address ?? '-'); ?></td>
                        </tr>
    ...
    <div class="flex flex-col items-center justify-between gap-4 py-4 sm:flex-row">
        <p class="text-sm text-slate-600">Menampilkan <?php echo e($attendances->count()); ?> catatan</p>
        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/student/attendance-history.blade.php ENDPATH**/ ?>