...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard - SMPN 13 Sungai Raya'); ?></title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex flex-1 flex-col overflow-hidden">
            ...
            <?php if(session('error') || $errors->any()): ?>
                <div x-data="{ show: true }"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="font-medium text-red-900"><?php echo e(session('error') ?? 'Terjadi kesalahan'); ?></p>
                            <?php if($errors->any()): ?>
            ...
            <footer class="border-t border-slate-200 bg-white px-6 py-4 text-center text-xs text-slate-500">
                &copy; <?php echo e(date('Y')); ?> SMPN 13 &middot; Sistem Informasi Akademik
            </footer>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/layouts/app.blade.php ENDPATH**/ ?>