...
<?php $__env->startSection('breadcrumb', 'Siswa › Absensi Hari Ini'); ?>
...
<div class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-200 bg-blue-50 p-5 text-sm text-slate-700">
        <div class="flex items-start gap-3">
            ...
            <div class="space-y-1">
                ...
                <p class="text-slate-700">1. Jam Masuk Sekolah: <span class="font-bold text-navy"><?php echo e(config('app.school_entry_time', '06:45')); ?> WIB</span>.</p>
    ...
    <div class="mx-auto w-full max-w-lg rounded-2xl bg-white p-6 shadow-sm mb-20" x-data="attendanceForm()">
        ...
        <form method="POST" action="<?php echo e(route('student.attendance.store')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select
                    ...
                    class="w-full rounded-2xl border-2 border-slate-200 bg-white px-4 py-3 text-sm text-slate-700 transition focus:border-navy focus:outline-none focus:ring-2 focus:ring-navy/20 <?php $__errorArgs = ['academic_class_id'];
...
unset($__errorArgs, $__bag); ?>"
                >
                    ...
                    <?php $__currentLoopData = $classes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($class->id); ?>" <?php echo e(old('academic_class_id') == $class->id ? 'selected' : ''); ?>><?php echo e($class->name); ?></option>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-2 text-sm text-red-500">Error Lokasi: <?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-2 text-sm text-red-500">Error Jarak: <?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            </div>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('attendanceForm', () => ({
            ...
            status: 'present',
            attendance_time: '',
            schoolLat: parseFloat("<?php echo e(config('app.school_latitude', '-0.0360278')); ?>"),
            schoolLng: parseFloat("<?php echo e(config('app.school_longitude', '109.3568889')); ?>"),
            loadingLocation: true,
            locationError: '',
            isLate: false,
            entryTime: "<?php echo e(config('app.school_entry_time', '06:45')); ?>",
            lateTolerance: parseInt("<?php echo e(config('app.school_late_tolerance_minutes', 15)); ?>"),
            cameraActive: false,
            captured: false,
            selfieBase64: '',
            selfiePreview: '',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/student/attendance.blade.php ENDPATH**/ ?>