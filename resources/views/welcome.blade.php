...
@section('title', 'SMPN 13 Sungai Raya - Portal Akademik')

@section('content')

<!-- Hero Section with Search -->
<section class="relative bg-slate-800 text-white py-32 overflow-hidden">
    <img src="{{ asset('images/sekolah/IMG_4903.JPG') }}" alt="SMPN 13 Sungai Raya" class="absolute inset-0 w-full h-full object-cover">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div class="md:col-span-4">
                <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden h-full flex flex-col">
                    <img src="{{ asset('images/sekolah/IMG_4904.JPG') }}" alt="Galeri" class="w-full h-64 object-cover">
                    ...
                    <div>
                        ...
                        <div class="aspect-video bg-slate-900 rounded-lg mb-4 overflow-hidden relative">
                            <video class="w-full h-full object-cover" controls preload="metadata">
                                <source src="{{ asset('videos/sambutan.mp4') }}" type="video/mp4">
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow border border-slate-100 overflow-hidden group">
                <div class="h-48 bg-slate-200 overflow-hidden">
                    <img src="{{ asset('images/mpls/IMG_4389.jpeg') }}" alt="News" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow border border-slate-100 overflow-hidden group">
                <div class="h-48 bg-slate-200 overflow-hidden">
                    <img src="{{ asset('images/sekolah/IMG_4905.JPG') }}" alt="News" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow border border-slate-100 overflow-hidden group">
                <div class="h-48 bg-slate-200 overflow-hidden">
                    <img src="{{ asset('images/mpls/IMG_4897.JPG') }}" alt="News" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                </div>
                <div class="p-6">
        ...
        <div class="text-center mt-10">
            <a href="{{ route('berita.index') }}" class="inline-block px-8 py-3 border-2 border-blue-900 text-blue-900 font-bold rounded-full hover:bg-blue-900 hover:text-white transition">Tampilkan Semua Berita</a>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col group">
                <div class="h-64 bg-slate-200 overflow-hidden relative">
                    <img src="{{ asset('images/nasional/IMG_0153.jpeg') }}" alt="Prestasi Nasional" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col group">
                <div class="h-64 bg-slate-200 overflow-hidden relative">
                    <img src="{{ asset('images/provinsi/IMG_4884.JPG') }}" alt="Prestasi Provinsi" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
