...
<?php $__env->startSection('breadcrumb', 'Beranda › Dashboard'); ?>
...
<?php if($role === 'admin'): ?>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap gap-3 mb-6">
            <a href="<?php echo e(route('admin.students.create')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition">
            ...
            <a href="<?php echo e(route('admin.teachers.create')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 transition">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 3a4 4 0 1 1 0 8 4 4 0 0 1 0-8z"></path>
                </svg>
                + Tambah Guru
            </a>
            <a href="<?php echo e(route('admin.academic-classes.create')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-purple-700 transition">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20M4 19.5v-14a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v14M4 19.5h16"></path>
                </svg>
                + Buat Kelas Baru
            </a>
            <a href="<?php echo e(route('admin.schedules.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-amber-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-700 transition">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line>
                </svg>
                Atur Jadwal
            </a>
            <a href="<?php echo e(route('admin.announcements.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-slate-100 px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-200 transition border border-slate-200">
                <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            <!-- Total Siswa -->
            <a href="<?php echo e(route('admin.students.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-blue-500 hover:shadow-md transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-blue-600 transition"><?php echo e(number_format($statistics['students'] ?? 0)); ?></h4>
            ...
            <!-- Total Guru -->
            <a href="<?php echo e(route('admin.teachers.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-amber-500 hover:shadow-md transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-amber-600 transition"><?php echo e(number_format($statistics['teachers'] ?? 0)); ?></h4>
            ...
            <!-- Kelas Aktif -->
            <a href="<?php echo e(route('admin.academic-classes.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-emerald-500 hover:shadow-md transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-emerald-600 transition"><?php echo e(number_format($statistics['classes'] ?? 0)); ?></h4>
            ...
            <!-- Mata Pelajaran -->
            <a href="<?php echo e(route('admin.subjects.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-purple-500 hover:shadow-md transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-purple-600 transition"><?php echo e(number_format($statistics['subjects'] ?? 0)); ?></h4>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentAnnouncements ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="grid border-b border-slate-200 py-4 last:border-0">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h5 class="text-sm font-semibold text-slate-800"><?php echo e($ann->title); ?></h5>
                                    <p class="text-xs text-slate-500 mt-1"><?php echo e($ann->created_at?->format('d M Y H:i')); ?></p>
                                </div>
                                <span class="inline-block rounded bg-amber-100 px-2.5 py-1 text-xs font-medium text-amber-600"><?php echo e($ann->target_audience ?? 'Umum'); ?></span>
                            </div>
                        </div>
                ...
                <div class="flex flex-col space-y-4 pb-4">
                    ...
                    <div>
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold text-slate-900"><?php echo e(number_format($statistics['users'] ?? 0)); ?></span>
                        </div>
                    ...
                    <div>
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold text-slate-900"><?php echo e(number_format($statistics['schedules'] ?? 0)); ?></span>
                        </div>
                        <div class="h-2 rounded-full bg-slate-100">
                    ...
                    <div>
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold text-slate-900"><?php echo e(number_format($statistics['grades'] ?? 0)); ?></span>
                        </div>
                        <div class="h-2 rounded-full bg-slate-100">
...
<?php elseif($role === 'teacher'): ?>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-wrap gap-3 mb-6">
            <a href="<?php echo e(route('teacher.grades.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 transition">
            ...
            <a href="<?php echo e(route('teacher.classes.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-purple-700 transition">
            ...
            <a href="<?php echo e(route('teacher.schedule.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 transition">
            ...
            <a href="<?php echo e(route('teacher.warning-letters.index')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-rose-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-rose-700 transition">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4 md:gap-6 2xl:gap-7.5">
            <!-- Kelas Saya -->
            <a href="<?php echo e(route('teacher.classes.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-blue-500 hover:shadow-md transition">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-slate-100 text-blue-600 mb-4 w-12 h-12 group-hover:bg-blue-600 group-hover:text-white transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                </div>
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-blue-600 transition"><?php echo e(number_format($personalStats['classes'] ?? 0)); ?></h4>
            ...
            <!-- Total Siswa -->
            <a href="<?php echo e(route('teacher.students.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-amber-500 hover:shadow-md transition">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-slate-100 text-amber-600 mb-4 w-12 h-12 group-hover:bg-amber-600 group-hover:text-white transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-amber-600 transition"><?php echo e(number_format($personalStats['students'] ?? 0)); ?></h4>
            ...
            <!-- Nilai Diinput -->
            <a href="<?php echo e(route('teacher.grades.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-emerald-500 hover:shadow-md transition">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-slate-100 text-emerald-600 mb-4 w-12 h-12 group-hover:bg-emerald-600 group-hover:text-white transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                </div>
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-emerald-600 transition"><?php echo e(number_format($personalStats['grades'] ?? 0)); ?></h4>
            ...
            <!-- Absensi Hari Ini -->
            <a href="<?php echo e(route('teacher.attendance.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-indigo-500 hover:shadow-md transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-indigo-600 transition"><?php echo e(number_format($personalStats['today_attendances'] ?? 0)); ?></h4>
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5 xl:grid-cols-3">
                ...
                <div class="flex flex-col">
                    <?php $__empty_1 = true; $__currentLoopData = $recentAttendances ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="grid border-b border-slate-200 py-3 last:border-0">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h5 class="text-sm font-semibold text-slate-800"><?php echo e($attendance->student->user->name ?? 'Siswa'); ?></h5>
                                    <p class="text-xs text-slate-500 mt-0.5">Kelas: <?php echo e($attendance->academicClass->name ?? '-'); ?> • <?php echo e($attendance->attendance_time?->format('d M Y H:i')); ?></p>
                                </div>
                                ...
                                ?>
                                <span class="inline-block rounded <?php echo e($statusColor); ?> px-2.5 py-1 text-xs font-medium"><?php echo e($statusText); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="py-4 text-center">
            ...
            <div class="col-span-1 rounded-xl border border-slate-200 bg-white px-5 pt-6 pb-2.5 shadow-sm sm:px-7">
                ...
                <div class="flex flex-col space-y-3">
                    <a href="<?php echo e(route('teacher.grades.index')); ?>" class="group flex items-center gap-4 rounded-lg border border-slate-200 p-3 hover:border-blue-500 hover:bg-blue-50 transition">
                    ...
                    <a href="<?php echo e(route('teacher.classes.index')); ?>" class="group flex items-center gap-4 rounded-lg border border-slate-200 p-3 hover:border-amber-500 hover:bg-amber-50 transition">
                    ...
                    <a href="<?php echo e(route('teacher.schedule.index')); ?>" class="group flex items-center gap-4 rounded-lg border border-slate-200 p-3 hover:border-emerald-500 hover:bg-emerald-50 transition">
            ...
            <div class="col-span-1 rounded-xl border border-slate-200 bg-white px-5 pt-6 pb-2.5 shadow-sm sm:px-7 xl:col-span-2">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="<?php echo e(route('teacher.warning-letters.index')); ?>" class="text-sm font-semibold text-navy hover:underline">Lihat Semua</a>
                </div>
                <div class="flex flex-col">
                    <?php $__empty_1 = true; $__currentLoopData = $recentWarningLetters ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="grid border-b border-slate-200 py-3 last:border-0">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h5 class="text-sm font-semibold text-slate-800"><?php echo e($wl->student->user->name ?? 'Siswa'); ?></h5>
                                    <p class="text-xs text-slate-500 mt-0.5">Tingkat: <span class="font-bold text-rose-600"><?php echo e($wl->type); ?></span> • Alasan: <?php echo e($wl->reason); ?></p>
                                </div>
                                <span class="inline-block rounded px-2.5 py-1 text-xs font-semibold <?php echo e($wl->resolved_at ? 'bg-emerald-100 text-emerald-600' : 'bg-rose-100 text-rose-600'); ?>">
                                    <?php echo e($wl->resolved_at ? 'Dicabut' : 'Aktif'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 2xl:gap-7.5">
            <a href="<?php echo e(route('student.attendance.history')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-blue-500 hover:shadow-md transition">
                ...
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-blue-600 transition"><?php echo e($personalStats['attendanceRate'] ?? 0); ?></h4>
                        <span class="text-sm font-medium text-slate-500">Tingkat Kehadiran ›</span>
                    </div>
                </div>
            </a>
            
            <a href="<?php echo e(route('student.records.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-amber-500 hover:shadow-md transition">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-slate-100 text-amber-600 mb-4 w-12 h-12 group-hover:bg-amber-600 group-hover:text-white transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                </div>
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-amber-600 transition"><?php echo e(number_format($personalStats['grades'] ?? 0)); ?></h4>
                        <span class="text-sm font-medium text-slate-500">Nilai Tercatat ›</span>
                    </div>
                </div>
            </a>

            <a href="<?php echo e(route('student.classes.index')); ?>" class="group block rounded-xl border border-slate-200 bg-white px-7 py-6 shadow-sm hover:border-emerald-500 hover:shadow-md transition">
                <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-slate-100 text-emerald-600 mb-4 w-12 h-12 group-hover:bg-emerald-600 group-hover:text-white transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                </div>
                <div class="mt-4 flex items-end justify-between">
                    <div>
                        <h4 class="text-title-md font-bold text-slate-800 text-2xl group-hover:text-emerald-600 transition"><?php echo e(number_format($personalStats['classes'] ?? 0)); ?></h4>
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5 lg:grid-cols-2">
            <div class="rounded-xl border border-slate-200 bg-white px-5 pt-6 pb-2.5 shadow-sm sm:px-7">
                ...
                <div class="flex flex-col space-y-3 pb-4">
                    <a href="<?php echo e(route('student.records.index')); ?>" class="group flex items-center gap-4 rounded-lg border border-slate-200 p-3 hover:border-blue-500 hover:bg-blue-50 transition">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded bg-blue-100 text-blue-600">
                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"></path></svg>
                        </div>
                        <div>
                    ...
                    <a href="<?php echo e(route('student.attendance.index')); ?>" class="group flex items-center gap-4 rounded-lg border border-slate-200 p-3 hover:border-amber-500 hover:bg-amber-50 transition">
                        <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded bg-amber-100 text-amber-600">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/dashboard.blade.php ENDPATH**/ ?>