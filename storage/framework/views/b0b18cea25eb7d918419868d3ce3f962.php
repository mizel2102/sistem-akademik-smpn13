...
<body>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <div class="value"><?php echo e($studentCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Teachers</div>
            <div class="value"><?php echo e($teacherCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Administrators</div>
            <div class="value"><?php echo e($adminCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Defined roles</div>
            <div class="value"><?php echo e($totalRoles); ?></div>
        </div>
        <div class="card">
            <div class="title">Academic classes</div>
            <div class="value"><?php echo e($classCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Subjects</div>
            <div class="value"><?php echo e($subjectCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Academic years</div>
            <div class="value"><?php echo e($academicYearCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Semesters</div>
            <div class="value"><?php echo e($semesterCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Schedules</div>
            <div class="value"><?php echo e($scheduleCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Announcements</div>
            <div class="value"><?php echo e($announcementCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Grades recorded</div>
            <div class="value"><?php echo e($gradeCount); ?></div>
        </div>
        <div class="card">
            <div class="title">Attendance records</div>
            <div class="value"><?php echo e($attendanceCount); ?></div>
        </div>
    </div>

</body>
</html>
<?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/admin/reports-pdf.blade.php ENDPATH**/ ?>