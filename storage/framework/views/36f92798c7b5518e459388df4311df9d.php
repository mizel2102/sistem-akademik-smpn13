...
<div class="space-y-6">
    <div class="flex flex-col gap-4 rounded-2xl bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        ...
        <form action="<?php echo e(route('notifications.markAllRead')); ?>" method="POST" class="inline-flex">
            <?php echo csrf_field(); ?>
    ...
    <div class="rounded-2xl bg-white shadow-sm">
        <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="flex items-start gap-3 border-b border-slate-100 px-5 py-4 transition-colors <?php echo e($notif->read_at ? '' : 'bg-amber-50/40 border-l-4 border-gold hover:bg-slate-50'); ?>">
                <div class="mt-1">
                ...
                <div class="min-w-0">
                    <p class="text-sm <?php echo e($notif->read_at ? 'text-slate-700' : 'font-semibold text-slate-900'); ?>"><?php echo e($notif->data['message'] ?? 'Notifikasi'); ?></p>
                    <p class="mt-1 text-xs text-slate-400"><?php echo e($notif->created_at->diffForHumans()); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/notifications/index.blade.php ENDPATH**/ ?>