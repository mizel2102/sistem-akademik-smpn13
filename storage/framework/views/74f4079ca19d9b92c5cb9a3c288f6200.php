...
<head>
  <meta charset="UTF-8">
  <title>Rapor - <?php echo e($student->user?->name); ?></title>
  <style>
...
<table class="info-table">
  <tr>
    ...
    <td style="width:35%;"><div class="info-value"><?php echo e($student->user?->name ?? '-'); ?></div></td>
    <td style="width:15%;"><div class="info-label">Jenis Kelamin</div></td>
    <td style="width:35%;"><div class="info-value"><?php echo e($student->user?->gender ?? '-'); ?></div></td>
  </tr>
  <tr>
    <td><div class="info-label">NIS</div></td>
    <td><div class="info-value"><?php echo e($student->student_number ?? '-'); ?></div></td>
    <td><div class="info-label">Wali Kelas</div></td>
    <td><div class="info-value"><?php echo e($student->academicClass?->teacher?->user?->name ?? '-'); ?></div></td>
  </tr>
  <tr>
    <td><div class="info-label">Kelas</div></td>
    <td><div class="info-value"><?php echo e($student->academicClass?->name ?? '-'); ?></div></td>
    <td><div class="info-label">Tahun Ajaran</div></td>
    <td><div class="info-value"><?php echo e($student->grades->first()?->semester?->academicYear?->name ?? '-'); ?></div></td>
  </tr>
  <tr>
    <td><div class="info-label">Tingkat</div></td>
    <td><div class="info-value"><?php echo e($student->academicClass?->grade_level ?? '-'); ?></div></td>
    <td></td>
    <td></td>
  </tr>
</table>
...
<?php $__currentLoopData = $gradesBySemester; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semName => $grades): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="semester-header"><?php echo e($semName); ?></div>
  <table>
    <thead>
      <tr>
        <th>No</th>
    ...
    <tbody>
    <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        <td><?php echo e($i + 1); ?></td>
        <td><?php echo e($grade->subject?->name ?? '-'); ?></td>
        <td class="<?php echo e($grade->score >= 75 ? 'score-high' : ($grade->score >= 60 ? 'score-mid' : 'score-low')); ?>">
          <?php echo e($grade->score); ?>

        </td>
        <td class="<?php echo e($grade->status === 'pass' ? 'lulus' : ($grade->status === 'fail' ? 'tidak-lulus' : 'remedial')); ?>">
          <?php echo e($grade->status === 'pass' ? 'Lulus' : ($grade->status === 'fail' ? 'Tidak Lulus' : 'Remedial')); ?>
...
<table style="width:100%; border:none; margin-top:16px;">
  <tr>
    ...
    <td style="padding:10px; background:#eef0f9; border-radius:6px; font-size:18px; font-weight:900; color:#1A2B6D; border:none; text-align:right;">
      <?php echo e(number_format($student->grades->avg('score'), 1)); ?>
...
<?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/admin/reports/rapor_pdf.blade.php ENDPATH**/ ?>