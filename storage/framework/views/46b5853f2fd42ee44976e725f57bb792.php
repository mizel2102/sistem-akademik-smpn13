...
<div class="space-y-6">
    ...
    <div class="rounded-2xl bg-white p-6 shadow-sm">
                ...
                <?php if(isset($students) && $students->isNotEmpty()): ?>
                    ...
                    >
                        ...
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($student->id); ?>" <?php echo e($selectedId == $student->id ? 'selected' : ''); ?>>
                                <?php echo e($student->name); ?><?php echo e($student->user?->email ? ' — ' . $student->user->email : ''); ?>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <label class="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">
                        <input type="radio" name="report_type" value="rapor" <?php echo e(old('report_type', request('report_type', 'rapor')) === 'rapor' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500" />
                        Rapor Siswa
                    </label>
                    <label class="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">
                        <input type="radio" name="report_type" value="rekap" <?php echo e(old('report_type', request('report_type', 'rapor')) === 'rekap' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500" />
                        Rekap Nilai
                    </label>
                </div>
            </div>
        ...
        <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <a
                href="<?php echo e($selectedId ? route('admin.reports.rapor', ['student' => $selectedId]) : '#'); ?>"
                ...
                <?php if(!$selectedId): ?> aria-disabled="true" <?php endif; ?>
            >
                Lihat Laporan
            </a>
            <a
                href="<?php echo e($selectedId ? route('admin.reports.rapor.pdf', ['student' => $selectedId]) : '#'); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/admin/reports.blade.php ENDPATH**/ ?>