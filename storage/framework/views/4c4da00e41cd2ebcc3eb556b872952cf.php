...
<div class="flex h-[60px] items-center border-b border-slate-200 bg-white shadow-sm">
    ...
    <div class="flex flex-1 items-center gap-4 px-6">
        ...
        <div>
            <h1 class="text-lg font-semibold text-slate-900"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
            <p class="text-xs text-slate-500"><?php echo $__env->yieldContent('breadcrumb', ''); ?></p>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/partials/topbar.blade.php ENDPATH**/ ?>