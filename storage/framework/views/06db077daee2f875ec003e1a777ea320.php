...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'label' => '', 'options' => [], 'value' => '', 'placeholder' => '-- Pilih --', 'required' => false, 'error' => '']));
...
foreach (array_filter((['name', 'label' => '', 'options' => [], 'value' => '', 'placeholder' => '-- Pilih --', 'required' => false, 'error' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="space-y-2">
    ...
    >
        ...
        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optValue => $optLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($optValue); ?>" <?php if(old($name, $value) == $optValue): ?> selected <?php endif; ?>>
                <?php echo e($optLabel); ?>
...
<?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/components/select.blade.php ENDPATH**/ ?>