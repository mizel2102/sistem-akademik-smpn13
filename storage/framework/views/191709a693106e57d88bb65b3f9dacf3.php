<?php $__env->startSection('title', 'Profil Guru - SMPN 13 Sungai Raya | Portal Akademik Digital'); ?>
    ...
    <section class="py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 min-h-[50vh]">
        <div class="max-w-7xl mx-auto">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-sky-50/50 transition-colors duration-200">
                                    <td class="px-6 py-4 text-slate-500 text-center"><?php echo e($i+1); ?></td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="h-10 w-10 bg-sky-100 rounded-full flex items-center justify-center text-sky-600 font-bold text-xs ring-2 ring-white shadow-sm"><?php echo e($t->initials ?? 'GS'); ?></div>
                                            <div>
                                                <p class="font-bold text-slate-800"><?php echo e($t->name); ?></p>
                                                <p class="text-xs text-slate-500 mt-0.5">NIP: <?php echo e($t->nip ?? '-'); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 hidden md:table-cell text-slate-600 text-xs"><?php echo e($t->degree ?? 'S1 Pendidikan'); ?></td>
                                </tr>
            ...
            <div class="flex items-center justify-between mt-8">
                <p class="text-sm text-slate-500">Menampilkan 1 hingga <?php echo e(count($teachers)); ?> dari total pengajar</p>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/guru/index.blade.php ENDPATH**/ ?>