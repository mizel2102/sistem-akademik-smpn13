...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="@yield('meta_description', 'Portal Akademik Digital SMPN 13 Sungai Raya — Akses nilai, jadwal, absensi, dan pengumuman sekolah dalam satu platform terpadu.')">
    ...
    <meta property="og:image" content="{{ asset('images/logo_academics.jpg') }}">
