...
@section('title', 'Masuk - SMPN 13 Kota')
                    ...
                    <div class="space-y-6">
                        ...
                        <form action="{{ route('login') }}" method="POST" class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="{{ route('password.request') }}" class="text-sm font-semibold text-navy hover:text-gold transition">
                                    Lupa kata sandi?
                                </a>
                            </div>
                        ...
                        @if(Route::has('register'))
                            <p class="text-center text-sm text-slate-600">
                                Belum punya akun?
                                <a href="{{ route('register') }}" class="font-bold text-navy hover:text-gold transition">
                                    Daftar di sini
                                </a>
                            </p>
                        @endif
