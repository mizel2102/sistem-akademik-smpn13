<?php $__env->startSection('title', 'Prestasi - SMPN 13 Sungai Raya | Portal Akademik Digital'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col relative overflow-hidden">
                    <div class="h-48 bg-slate-200 overflow-hidden relative">
                        <img src="<?php echo e(asset('images/nasional/IMG_4507.jpeg')); ?>" alt="Sains Matematika" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col relative overflow-hidden">
                    <div class="h-48 bg-slate-200 overflow-hidden relative">
                        <img src="<?php echo e(asset('images/nasional/IMG_4645.jpeg')); ?>" alt="Robotics" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col relative overflow-hidden">
                    <div class="h-48 bg-slate-200 overflow-hidden relative">
                        <img src="<?php echo e(asset('images/nasional/IMG_4695.jpeg')); ?>" alt="Seni Rupa" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        <div class="absolute top-4 right-4 bg-yellow-500 text-blue-900 font-bold px-2.5 py-1 rounded shadow text-xs uppercase tracking-wider">Nasional</div>
                    </div>
                    <div class="p-6 flex-1 flex flex-col relative z-10">
                        <div class="flex justify-between items-start mb-3">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col relative overflow-hidden">
                    <div class="h-48 bg-slate-200 overflow-hidden relative">
                        <img src="<?php echo e(asset('images/provinsi/IMG_4885.JPG')); ?>" alt="Debat Bahasa" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col relative overflow-hidden">
                    <div class="h-48 bg-slate-200 overflow-hidden relative">
                        <img src="<?php echo e(asset('images/nasional/IMG_0153.jpeg')); ?>" alt="Wirausaha" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        <div class="absolute top-4 right-4 bg-yellow-500 text-blue-900 font-bold px-2.5 py-1 rounded shadow text-xs uppercase tracking-wider">Nasional</div>
                    </div>
                    <div class="p-6 flex-1 flex flex-col relative z-10">
                        <div class="flex justify-between items-start mb-3">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col relative overflow-hidden">
                    <div class="h-48 bg-slate-200 overflow-hidden relative">
                        <img src="<?php echo e(asset('images/provinsi/IMG_4887.JPG')); ?>" alt="Musik" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        <div class="absolute top-4 right-4 bg-yellow-500 text-blue-900 font-bold px-2.5 py-1 rounded shadow text-xs uppercase tracking-wider">Nasional</div>
                    </div>
                    <div class="p-6 flex-1 flex flex-col relative z-10">
                        <div class="flex justify-between items-start mb-3">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistem-akademik-smpn13\resources\views/prestasi/index.blade.php ENDPATH**/ ?>